...
urlpatterns = [
    ...
    path('help/', views.support_help_view, name='support_help'),
    ...
    path('app-admin/users/<int:employee_id>/reset-password/', views.admin_user_reset_password_view, name='admin_user_reset_password'),
    ...
    path('app-admin/support-requests/', views.admin_support_requests_view, name='admin_support_requests'),
    path('app-admin/support-requests/<int:request_id>/update/', views.admin_support_request_update_view, name='admin_support_request_update'),
